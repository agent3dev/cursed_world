...
private:
    ...
    std::unique_ptr<Border> borderStyle;  // Border/wall around the matrix
...
public:
    ...
    // Draw a margin/border with specified character (deprecated - use setBorder)
    void margin(const std::string& borderChar = "#");

    // Set the border style
    void setBorder(Border* b);  // Takes ownership
    Border* getBorder() const { return borderStyle.get(); }
    bool hasBorder() const { return borderStyle != nullptr; }
